/*
===============================================================================
Хранимая процедура: Загрузка слоя Silver (Bronze -> Silver)
===============================================================================
Назначение скрипта:
    Эта хранимая процедура выполняет процесс ETL (Извлечение, Трансформация, Загрузка)
    для заполнения таблиц схемы 'silver' данными из схемы 'bronze'.
    Выполняемые действия:
        - Очищает (TRUNCATE) таблицы слоя Silver.
        - Вставляет трансформированные и очищенные данные из Bronze в таблицы Silver.
		
Параметры:
    Нет. 
    Эта хранимая процедура не принимает никаких параметров и не возвращает значений.
