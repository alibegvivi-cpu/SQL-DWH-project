/*
===============================================================================
Хранимая процедура: Загрузка Бронзового слоя (Источник -> Бронза)
===============================================================================
Назначение скрипта:
    Эта хранимая процедура загружает данные в схему 'bronze' из внешних CSV-файлов.
    Она выполняет следующие действия:
    - Полностью очищает (TRUNCATE) бронзовые таблицы перед загрузкой данных.
    - Использует команду `COPY` для массового импорта данных из CSV-файлов в таблицы.
